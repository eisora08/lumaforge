  ...
  return (
    <section>
      <div className="mb-3 flex items-center justify-between">
        ...
        <button className="inline-flex items-center gap-2 text-xs text-gray-400 hover:text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        {actions.map((action) => {
          ...
          return (
            <button
              key={action.label}
              className="group rounded-2xl border border-white/10 bg-[#302b2f] p-4 text-left hover:bg-[#393237] transition"
            >
              <div
              ...
              <h3 className="font-medium text-white group-hover:text-[#b8d7dc]">
                {action.label}
              </h3>
