  ...
  return (
    <section className="border border-white/15 bg-white/3 rounded-2xl p-8 text-center">
      ...
      <h3 className="font-semibold text-white">
        {t("dashboard.drop_zone.title", "Instalar paquete manualmente")}
      </h3>

      <p className="text-gray-400 text-sm mt-2 max-w-md mx-auto">
        {t("dashboard.drop_zone.description", "Arrastra un .zip, .lua o .manifest. LumaForge enviará cada archivo a su carpeta correcta.")}
      </p>
      ...
      >
        ...
        {t("dashboard.drop_zone.browse", "Buscar archivos")}
      </button>
    </section>
  );
}