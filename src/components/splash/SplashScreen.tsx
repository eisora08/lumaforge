        ...
        <div className="mb-7 h-[310px] w-[310px] flex-shrink-0">
          ...
          >
            ...
            <g id="layer5">
              ...
              />
              <path
                style={{ fill: "#d8e1eb", fillOpacity: 1, stroke: "none" }}
              ...
              />
              <path
                style={{ fill: "#3f495f", fillOpacity: 0.15291937, stroke: "none" }}
              ...
              />
              <path
                style={{ fill: "#c6d4e1", fillOpacity: 1, stroke: "none" }}
              ...
              />
              <path
                style={{ fill: "#cbd6e3", fillOpacity: 1, stroke: "none" }}
            ...
            <g id="layer3">
              <path
                style={{ fill: "#7180a1", fillOpacity: 1, stroke: "none" }}
              ...
              />
              <path
                style={{ fill: "#3f495f", fillOpacity: 0.184314, stroke: "none" }}
              ...
              />
              <path
                style={{ fill: "#56627c", fillOpacity: 1, stroke: "none" }}
              ...
              />
              <path
                style={{ fill: "#63708d", fillOpacity: 1, stroke: "none" }}
              ...
              />
              <path
                style={{ fill: "#56627c", fillOpacity: 0.799, stroke: "none" }}
