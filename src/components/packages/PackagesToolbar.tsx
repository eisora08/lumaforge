...
export default function PackagesToolbar({
  ...
  const searchSection = (
    <div ref={wrapperRef} className="relative">
      ...
      {shouldShowDropdown && (
        <div className="absolute left-0 right-0 top-12 z-50 overflow-hidden rounded-2xl border border-(--surface-active-border) bg-black/95 shadow-2xl backdrop-blur-xl">
          {searchLoading ? (
            ...
            <>
              ...
              {(hasMoreResults || normalizedQuery.length > 0) && (
                <button
                  ...
                  className="flex w-full items-center justify-between border-t border-white/10 px-4 py-3 text-sm text-(--color-text) transition hover:bg-white/10"
                >
                  <span>
