...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::epic_games::read_epic_games,
            commands::epic_games::write_epic_games,
            commands::epic_games::backup_epic_games,
            ...
            commands::sqlite_cache::upsert_achievement_entry,
            commands::sqlite_cache::batch_upsert_achievement_entries,
            commands::sqlite_cache::get_achievement_entries,
